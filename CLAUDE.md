...
**Version:** 1.2.11 | **Tests:** 378/385 passing (98.2%) | **Exported Commands:** ~195
...
|---------|------|-------------|
| 1.2.11 | Jan 30, 2026 | Fix Rules DataGrid Group column blank (SID-to-name resolver, circle colors by scope) |
