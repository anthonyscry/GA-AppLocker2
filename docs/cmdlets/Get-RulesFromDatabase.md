...
```
Get-RulesFromDatabase [[-Status] <String>] [[-RuleType] <String>] [[-CollectionType] <String>]
 [[-SearchText] <String>] [[-GroupVendor] <String>] [[-Skip] <Int32>] [[-Take] <Int32>] [-CountOnly]
 [-FullPayload] [<CommonParameters>]
```
